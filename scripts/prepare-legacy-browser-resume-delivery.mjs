...
const ref = "c48effcac986247618e3440d02457f1fefa0ab95",
  expected = "2aefe2f95f3a412d1c6c4a6b7688e7fc0951c13378a60bc5a78581083cfa40d3";
...
const dir = join(repo, ".legacy-browser-resume-delivery");
await mkdir(dir, { recursive: true });
execFileSync("tar", ["-x", "-C", dir], { input: archive });
await writeFile(
  join(dir, "index.ts"),
  `export { BrowserResumeConsent } from './modules/remote/browser-resume-consent.js';
...
await build({
  ...
  root: repo,
  build: {
    outDir: join(repo, "tests/browser/fixture/public/legacy-resume-delivery"),
    emptyOutDir: true,
    lib: {
...
console.log(
  "Verified version16 module archive and built the actual previous common-storage providers.",
);
