...
const ref = "b1263ca9f2ccc4072f9e36e1b4a491bcd58ff3c6",
  expected = "1a0df2a908cbba37c5415c07970194357101e965b8a9e42438d5e9e381673389";
...
const dir = join(repo, ".legacy-browser-offer-ack");
...
await build({
  ...
  root: repo,
  build: {
    outDir: join(repo, "tests/browser/fixture/public/legacy-offer-ack"),
    emptyOutDir: true,
    lib: {
...
console.log(
  "Verified version10 module archive and built the actual previous common-storage providers.",
);
