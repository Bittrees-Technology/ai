...
The page links the pinned v0.1.0-preview.234 public GitHub prerelease, Mac development setup and provenance instructions, public source and public issue tracker. It labels release limitations and does not offer a notarized installer or claim that an app is connected. No JavaScript, forms, analytics, third-party fonts or task input are included. Response headers deny scripts, connections, forms and embedding, and suppress referral information. Domain assignment and successful production publication must be verified separately from build success.
